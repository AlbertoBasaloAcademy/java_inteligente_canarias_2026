...
model: Auto (copilot)
tools: ['vscode/askQuestions', 'read', 'search', 'agent', 'todo']
agents: ['1-analyst', '2-architect', '3-product-owner']
handoffs:
  - label: Prepare the Implementation
    agent: Engineer
    prompt: Prepare the coding repository and plan the implementation from the completed architecture and specification package.
    send: true
---
# Architect
